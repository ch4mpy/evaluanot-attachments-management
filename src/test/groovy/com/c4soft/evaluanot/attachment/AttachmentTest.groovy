...
class AttachmentTest {
	...
	public void testCompareTo() {
		...
		assertThat(attachment.compareTo(new Attachment(4000L, 99L, 99L, new Gallery('z', (Set<Format>)[new Format("binary")]), 'A', 99, 99, 'A')), is(greaterThan(0)));
		assertThat(attachment.compareTo(new Attachment(4002L, 0L, 0L, new Gallery('a', (Set<Format>)[new Format("binary")]), '0', 0, 0, '0')), is(lessThan(0)));

		assertThat(attachment.compareTo(new Attachment(4001L, 50L, 99L, new Gallery('z', (Set<Format>)[new Format("binary")]), 'A', 99, 99, 'A')), is(greaterThan(0)));
		assertThat(attachment.compareTo(new Attachment(4001L, 52L, 0L, new Gallery('a', (Set<Format>)[new Format("binary")]), '0', 0, 0, '0')), is(lessThan(0)));

		assertThat(attachment.compareTo(new Attachment(4001L, 51L, 0L, new Gallery('z', (Set<Format>)[new Format("binary")]), 'A', 99, 99, 'A')), is(greaterThan(0)));
		assertThat(attachment.compareTo(new Attachment(4001L, 51L, 99L, new Gallery('a', (Set<Format>)[new Format("binary")]), '0', 0, 0, '0')), is(lessThan(0)));

		assertThat(attachment.compareTo(new Attachment(4001L, 51L, 69L, new Gallery('photo', (Set<Format>)[new Format("binary")]), 'A', 99, 99, 'A')), is(greaterThan(0)));
		assertThat(attachment.compareTo(new Attachment(4001L, 51L, 69L, new Gallery('z', (Set<Format>)[new Format("binary")]), '0', 0, 0, '0')), is(lessThan(0)));
