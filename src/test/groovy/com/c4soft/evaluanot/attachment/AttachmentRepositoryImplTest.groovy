...
class AttachmentRepositoryImplTest {
	...
	private static final Gallery PHOTO = new Gallery('photo');
	...
	public void testThatCreateInExistingColumnMovesExistingAttachments() {
		Map<Integer, Map<Integer,  Entry<Attachment, Set<Format>>>> actual = repo.create([(FULLSIZE) : new File('target/test-classes/moto.jpg')], 4001L, 51L, 69L, PHOTO, 'monster', 1, 1);
