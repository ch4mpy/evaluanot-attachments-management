...
public interface AttachmentRepository {
	 ...
	 */
	Map<Integer, Map<Integer,  Entry<Attachment, Set<Format>>>> findByOfficeIdAndMissionIdAndBienIdAndGalleryMapByColumnAndRow(long officeId, long missionId, long bienId, Gallery gallery) throws IllegalArgumentException;
	 ...
	 */
	Map<Integer, Map<Integer,  Entry<Attachment, Set<Format>>>> create(Map<String, File> fileByFormat, long officeId, long missionId, long bienId, Gallery gallery, String label, int column, int row) throws IllegalArgumentException, AttachmentPersistenceException;
	 ...
	 */
	Map<Integer, Map<Integer,  Entry<Attachment, Set<Format>>>> move(Attachment attachment, int newColumn, int newRow) throws IllegalArgumentException, AttachmentPersistenceException;
